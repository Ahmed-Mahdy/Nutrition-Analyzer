...
protocol Repository {
    var provider: MoyaProvider<NutritionTarget> { get }
    var cachingPolicy: CachingPolicy { get }
    func getData<T: Codable>(_ destination: NutritionTarget, decodingType: T.Type) -> Observable<T>
}
...
extension Repository {
    ...
    private func fetchRemote<T: Codable>(_ destination: NutritionTarget, decodingType: T.Type) -> Single<T> {
